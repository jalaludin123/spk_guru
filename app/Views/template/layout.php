      ...
      <div class="slider-body px-1">
        <nav class="nav flex-column">
          <ul>
              ...
              <ul class="list">
                <li>
                  <a class="nav-link px-3" href="<?= base_url('admin/user'); ?>">
                    <i class="fa fa-users box-icon" aria-hidden="true"></i>Data User
                  </a>
                </li>
                <li>
            ...
            <?php } else { ?>
            <li>
              <a class="nav-link px-3" href="<?= base_url('admin/home'); ?>">
                <i class="fa fa-home fa-lg box-icon" aria-hidden="true"></i>Home
              </a>
            </li>
            <li>
              <a class="nav-link px-3" href="<?= base_url('admin/perhitungan'); ?>">
                <i class="fa fa-book fa-lg box-icon" aria-hidden="true"></i>Hasil Perhitungan
              </a>
            </li>
            <?php } ?>
            <hr class="soft my-1 bg-white" />
